    ...
    <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
      <fieldset class="form__block">
        ...
        <label class="form__label form__label--price" for="111">
          ...
          <input class="form__input" type="text" name="min-price" v-model.number="currentPriceFrom" id="111">

          <span class="form__value">От</span>
        </label>
        <label class="form__label form__label--price" for="112">

          <input class="form__input" type="text" name="max-price" v-model.number="currentPriceTo" id="112">
        ...
        <ul class="check-list">
          <li class="check-list__item">
            <label class="check-list__label" for="131">
              ...
              <input class="check-list__check sr-only" type="checkbox" name="volume" value="8" checked="" id="131">
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="132">
              ...
              <input class="check-list__check sr-only" type="checkbox" name="volume" value="16" id="132">
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="133">
              ...
              <input class="check-list__check sr-only" type="checkbox" name="volume" value="32" id="133">
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="134">
              ...
              <input class="check-list__check sr-only" type="checkbox" name="volume" value="64" id="134">
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="135">
              ...
              <input class="check-list__check sr-only" type="checkbox" name="volume" value="128" id="135">
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="136">
              ...
              <input class="check-list__check sr-only" type="checkbox" name="volume" value="264" id="136">
